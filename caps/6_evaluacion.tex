...
\begin{table}[H]
	...
	\begin{tabularx}{0.85\textwidth}{
			>{\centering\arraybackslash}p{0.7cm}  % SID
			>{\centering\arraybackslash}p{1.8cm}  % Modelo
			>{\centering\arraybackslash}p{0.7cm}  % EP
			>{\centering\arraybackslash}p{0.9cm}  % TL
			>{\centering\arraybackslash}p{1.2cm}  % TMAE
			>{\centering\arraybackslash}p{1.4cm}  % TRMSE
			>{\centering\arraybackslash}p{1.5cm}  % TMAPE
			>{\centering\arraybackslash}p{1.1cm}  % TR2
		}
		\toprule
