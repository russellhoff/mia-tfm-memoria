...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Modelos basados en transformer, que han demostrado una capacidad sobresaliente para captar dependencias espaciotemporales y superar limitaciones de modelos anteriores \cite{trafficformer, cai2020traffictransformer}.
	\end{itemize}
\end{itemize}
